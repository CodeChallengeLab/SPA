...
//         >
//           {combinedStore.isLoading ? 'Loading...' : 'Fetch Data'}
//         </Button>
//       </Paper>

//       {combinedStore.error && <ErrorMessage error={combinedStore.error} />}
      
//       {combinedStore.isLoading && <LoadingSpinner message="Fetching posts and users..." />}
